    ...
    <main class="mt-100">
        <div class="container">
            <div class="archive-header">
                ...
                <h2 class="font-weight-bold"><span class="font-family-normal">RIO VERDE</span></h2>
                                  ...
                                  <li class="mb-15">
                                      <div class="d-flex">
                                          <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale">
                                              <a class="color-white" href="{{ route('rio-verde.show', $Side_Data->id) }}">
                                                  <img src="{{$Side_Data->img}}" alt="">
                                              </a>
                                          </div>
                                          <div class="post-content media-body">
                                              <h6 class="post-title mb-10 text-limit-2-row"><a href="{{ route('rio-verde.show', $Side_Data->id) }}">{{$Side_Data->title}}</a></h6>
                                              <div class="entry-meta meta-1 font-x-small color-grey mt-10">
                                                  <span class="post-on mr-15">{{$Side_Data->updated_at}}</span>
                    ...
                    <div class="mb-30">
                        <article class="first-post mb-md-4 mb-lg-0 mb-30">
                            <h3 class="mb-20 position-relative font-weight-bold">
                                <a href="{{ route('rio-verde.show', $last_row_data->id) }}">{{$last_row_data->title}}</a>
                            </h3>
                            <figure class="mb-30">
                                <a href="{{ route('rio-verde.show', $last_row_data->id) }}">
                        ...
                        <div class="loop-grid-3">
                          @foreach ($all_data as $All_Data)
                            <article class="row wow fadeIn animated">
                                <div class="col-md-6">
                                    <figure class="mb-md-0 mb-sm-3"><a href="{{ route('rio-verde.show', $All_Data->id) }}"><img src="{{$All_Data->img}}" alt=""></a></figure>
                                </div>
                                <div class="col-md-6">
                                    <h4 class="post-title mb-10 font-weight-bold">
                                        <a href="{{ route('rio-verde.show', $All_Data->id) }}">{{$All_Data->title}}</a>
                                    </h4>
                                    <p class="excerpt mb-20 content-small-part-one">
                                        {{$All_Data->content}}
                                    </p>
                                    <div class="entry-meta meta-2 font-x-small color-muted">
                                        <p class="mb-5">
